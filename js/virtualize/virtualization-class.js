...
export class VirtualScroller {
  ...
  #loadInitData() {
    const scrollerRect = this.scroller.getBoundingClientRect(); //положение скролла
    const minCount = Math.ceil(scrollerRect.height / this.rowHeight); //миниальное количество отзывов
